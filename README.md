...
Latest stable release: [Cohub 2.1.2](https://github.com/atou42/cohub-skill/releases/tag/cohub-v2.1.2). [versions.json](versions.json) points to the verified release tag and commit. Install from that tag, not a potentially newer main checkout.
